				...
				case 'condition';
					...
					foreach ( $template_types as $template => $template_type ) {
						...
						if ( 'jet-woo-builder-myaccount' === $doc_type_slug ) {
							$myaccount_template_id = absint( jet_woo_builder_integration_woocommerce()->get_custom_myaccount_template() );
							$login_template_id     = absint( jet_woo_builder_integration_woocommerce()->get_custom_form_login_template() );
							$dashboard_template_id = absint( jet_woo_builder_integration_woocommerce()->get_custom_myaccount_dashboard_template() );
							$orders_template_id    = absint( jet_woo_builder_integration_woocommerce()->get_custom_myaccount_orders_template() );
							$downloads_template_id = absint( jet_woo_builder_integration_woocommerce()->get_custom_myaccount_downloads_template() );
							$address_template_id   = absint( jet_woo_builder_integration_woocommerce()->get_custom_myaccount_address_template() );
							$account_template_id   = absint( jet_woo_builder_integration_woocommerce()->get_custom_myaccount_account_template() );

							if ( $myaccount_template_id === $post_id ) {
								$col_condition_content = esc_html__( 'My Account Page', 'jet-woo-builder' );
							} elseif ( $login_template_id === $post_id ) {
								$col_condition_content = esc_html__( 'My Account Login Page', 'jet-woo-builder' );
							} elseif ( $dashboard_template_id === $post_id ) {
								$col_condition_content = esc_html__( 'My Account Dashboard', 'jet-woo-builder' );
							} elseif ( $orders_template_id === $post_id ) {
								$col_condition_content = esc_html__( 'My Account Orders', 'jet-woo-builder' );
							} elseif ( $downloads_template_id === $post_id ) {
								$col_condition_content = esc_html__( 'My Account Downloads', 'jet-woo-builder' );
							} elseif ( $address_template_id === $post_id ) {
								$col_condition_content = esc_html__( 'My Account Address', 'jet-woo-builder' );
							} elseif ( $account_template_id === $post_id ) {
								$col_condition_content = esc_html__( 'My Account Edit Account', 'jet-woo-builder' );
							}
