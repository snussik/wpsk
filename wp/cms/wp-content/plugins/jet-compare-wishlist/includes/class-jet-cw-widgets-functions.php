...
if ( ! class_exists( 'Jet_CW_Widgets_Functions' ) ) {
	...
	class Jet_CW_Widgets_Functions {
		...
		public function get_compare_table_rows_content( $display_settings = array(), $products ) {
			...
			$heading_tag = ! empty( $display_settings['compare_table_data_title_html_tag'] ) ? $display_settings['compare_table_data_title_html_tag'] : 'h5'; ?>
							...
							<div class="jet-wishlist-item">
								...
								<?php else : ?>
									...
									<div class="jet-wishlist-item__content">
										<?php echo jet_cw_functions()->get_wishlist_remove_button( $_product, $widget_settings ); ?>
										<?php if ( 'default' === $widget_settings['thumbnail_position'] ) : ?>
											<?php echo jet_cw_functions()->get_thumbnail( $_product, $widget_settings ); ?>
										<?php endif; ?>
										<?php echo '<' . $heading_tag . ' class="jet-cw-product-title" >' . jet_cw_functions()->get_title( $_product, $widget_settings ) . '</' . $heading_tag . '>'; ?>
										<?php echo jet_cw_functions()->get_add_to_cart_button( $_product ); ?>
										<?php echo jet_cw_functions()->get_price( $_product ); ?>
										<?php echo jet_cw_functions()->get_rating( $_product, $widget_settings ); ?>
									</div>
								<?php endif; ?>
							</div>
						</div>
